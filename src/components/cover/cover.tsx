    ...
    <div className="flex items-center justify-around flex-wrap p-4 mt-20">
      <div className="text-center font-gotham text-[#DCDFE5]">
        ...
        <div className="flex items-start justify-center flex-wrap mt-6 sm:mt-8 md:mt-10 lg:mt-12">
          <button className="bg-[#FF7506] font-bold text-black py-2 px-4 rounded-[32px] border-2 border-[#FF7506] hover:bg-transparent hover:text-[#FF7506] button-transition ">
            Inscreva-se Já
          </button>
